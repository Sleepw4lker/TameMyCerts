...
namespace TameMyCerts.Models
{
    ...
    {
        private readonly Dictionary<string, byte[]> _certificateExtensions = new Dictionary<string, byte[]>();
        ...
        /// </summary>
        public List<string> DisabledCertificateExtensions { get; } = new List<string>();
        ...
        /// </summary>
        public List<string> DisabledCertificateProperties { get; } = new List<string>();
