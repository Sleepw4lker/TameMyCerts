...
using System.Text;
using CERTENROLLLib;
using TameMyCerts.AdcsModules.Shared.ClassExtensions;
using TameMyCerts.AdcsModules.Shared.Enums;
using TameMyCerts.AdcsModules.Shared.X509;

namespace TameMyCerts.AdcsModules.Shared.Models;

public class CertificateDatabaseRow
{
    public CertificateDatabaseRow(
        ...
        Dictionary<string, byte[]> certificateExtensions,
        KeyAlgorithmFamily keyAlgorithm,
        List<KeyValuePair<string, string>> subjectRelativeDistinguishedNames)
    {
        NotBefore = notBefore;
        NotAfter = notAfter;
        KeyLength = keyLength;
        ...
        SubjectRelativeDistinguishedNames = subjectRelativeDistinguishedNames;
