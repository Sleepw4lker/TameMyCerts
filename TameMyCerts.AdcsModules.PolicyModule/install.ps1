...
New-Variable -Option Constant -Name FileList -Value @(
    ...
    "TameMyCerts.AdcsModules.PolicyModule.comhost.dll",
    "TameMyCerts.AdcsModules.PolicyModule.deps.json",
    "TameMyCerts.AdcsModules.PolicyModule.dll",
    "TameMyCerts.AdcsModules.PolicyModule.Events.dll",
    "TameMyCerts.AdcsModules.PolicyModule.Events.man",
    "TameMyCerts.AdcsModules.PolicyModule.runtimeconfig.json",
...
if (Test-Path -Path "$AppInstallDirectory\TameMyCerts.AdcsModules.PolicyModule.comhost.dll") {
    ...
    Start-Process `
        ...
        -ArgumentList "/s", "/u", """$AppInstallDirectory\TameMyCerts.AdcsModules.PolicyModule.comhost.dll""" `
        -Wait `
        -WindowStyle Hidden
}
...
<provider name="TameMyCerts-TameMyCerts-Policy" guid="{01e38251-e8f1-5aea-594c-12c672505ecf}" resourceFileName="TameMyCerts.AdcsModules.PolicyModule.Events.dll" messageFileName="TameMyCerts.AdcsModules.PolicyModule.Events.dll" symbol="TameMyCertsTameMyCertsPolicy">
</provider>
</events>
</instrumentation>
...
<instrumentation xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:win="http://manifests.microsoft.com/win/2004/08/windows/events">
<events xmlns="http://schemas.microsoft.com/win/2004/08/events">
<provider name="TameMyCerts" guid="{5ab879f8-8136-5440-4d8c-3d0ac8846520}" resourceFileName="TameMyCerts.AdcsModules.PolicyModule.Events.dll" messageFileName="TameMyCerts.AdcsModules.PolicyModule.Events.dll" symbol="TameMyCerts">
</provider>
</events>
</instrumentation>
</instrumentationManifest>
...
if (-not $Uninstall.IsPresent) {
    ...
    Start-Process `
        -FilePath "$($env:SystemRoot)\System32\regsvr32.exe" `
        -ArgumentList "/s", """$AppInstallDirectory\TameMyCerts.AdcsModules.PolicyModule.comhost.dll""" `
        -Wait `
        -WindowStyle Hidden
