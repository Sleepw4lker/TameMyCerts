...
public enum TmcFlag : uint
{
    ...
    /// <summary>
    ///     Causes Directory Service Validator to not perform nested group searching, which may come at the cost of additional
    ///     load
    ///     on Domain Controllers. Also, all Domain Controllers must be Windows Server 2016 or newer for revolving of nested
    ///     group memberships to work.
    /// </summary>
