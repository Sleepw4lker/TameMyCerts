...
namespace TameMyCerts.Tests
{
    ...
    public class RequestAttributeValidatorTests
    {
        ...
        private readonly RequestAttributeValidator _validator = new RequestAttributeValidator();
        ...
        public void Deny_StartDate_invalid()
        {
            ...
            Assert.IsTrue(result.StatusCode == WinError.ERROR_INVALID_TIME);
        }
        ...
        public void Allow_StartDate_no_flag()
        {
            ...
            Assert.IsTrue(result.StatusCode == WinError.ERROR_SUCCESS);
        }
        ...
        public void Deny_invalid_flags()
        {
            ...
            Assert.IsTrue(result.DeniedForIssuance);
            Assert.IsTrue(result.StatusCode == WinError.NTE_FAIL);
        }
