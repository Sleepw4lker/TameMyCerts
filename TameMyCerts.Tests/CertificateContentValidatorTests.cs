...
namespace TameMyCerts.Tests
{
    ...
    public class CertificateContentValidatorTests
    {
        ...
        private readonly CertificateContentValidator _validator = new CertificateContentValidator();
        ...
        public void Does_add_valid_CDP_and_AIA()
        {
            ...
            Assert.IsTrue(result.CertificateExtensions.ContainsKey(WinCrypt.szOID_CRL_DIST_POINTS) && Convert
                .ToBase64String(result.CertificateExtensions[WinCrypt.szOID_CRL_DIST_POINTS])
                .Equals(expectedCdp));

            Assert.IsTrue(result.CertificateExtensions.ContainsKey(WinCrypt.szOID_AUTHORITY_INFO_ACCESS) &&
        ...
        public void Does_add_static_RDN_when_not_present()
        {
            ...
            Assert.IsTrue(result.CertificateProperties.Any(x =>
        ...
        public void Does_not_add_static_RDN_when_present_and_not_forced()
        {
            ...
            Assert.IsFalse(result.CertificateProperties.Any(x =>
                x.Key.Equals(RdnTypes.NameProperty[RdnTypes.Organization]) && x.Value.Equals("ADCS Labor")));
        }
        ...
        public void Does_not_add_static_SAN_when_field_is_ivalid()
        {
            ...
            Assert.IsFalse(result.CertificateExtensions.ContainsKey(WinCrypt.szOID_SUBJECT_ALT_NAME2));
        }
        ...
        public void Adds_one_San_from_DS()
        {
            ...
            Assert.IsFalse(result.DeniedForIssuance);
            Assert.IsTrue(result.SubjectAlternativeNameExtension.ContainsAlternativeName(SanTypes.UserPrincipalName,
        ...
        public void Adds_more_than_one_San_from_DS_if_differing_values()
        {
            ...
            Assert.IsFalse(result.DeniedForIssuance);
            Assert.IsTrue(result.SubjectAlternativeNameExtension.AlternativeNames
        ...
        public void Deny_SAN_from_DS_if_incompatible_field_and_mandatory()
        {
            ...
            Assert.IsTrue(result.DeniedForIssuance);
            Assert.IsFalse(result.SubjectAlternativeNameExtension.ContainsAlternativeName(SanTypes.IpAddress,
                _dsObject.Attributes["userPrincipalName"]));
        }
        ...
        public void Deny_SAN_from_DS_if_invalid_field_and_mandatory()
        {
            ...
            Assert.IsTrue(result.DeniedForIssuance);
            Assert.IsFalse(result.SubjectAlternativeNameExtension.ContainsAlternativeName("thisisinvalid",
                _dsObject.Attributes["userPrincipalName"]));
        }
