...
namespace TameMyCerts.Tests.Shared;
...
public class X509CertificateExtensionSubjectAlternativeNameTests
{
    ...
    public void Decodes_one_dNSName()
    {
        ...
        Assert.True(sanExt.AlternativeNames[0].Key == SanTypes.DnsName);
        Assert.True(sanExt.AlternativeNames[0].Value == "some-test.tamemycerts-tests.local");
    }
    ...
    public void Decodes_one_rfc822Name()
    {
        ...
        Assert.True(sanExt.AlternativeNames[0].Key == SanTypes.Rfc822Name);
