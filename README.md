...
> TameMyCerts empowers the [Certiception](https://github.com/srlabs/Certiception) honeypot toolkit for AD CS to allow spotting adversaries trying to abuse a certification authority.
